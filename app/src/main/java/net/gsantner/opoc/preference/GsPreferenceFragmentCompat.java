 ...
 * Add dependencies:
 ...
 "com.android.support:preference-v14:${version_library_appcompat}"

 * Apply to activity using setTheme(), add to styles.xml/theme:
        <item
 name="preferenceTheme">@style/PreferenceThemeOverlay.v14.Material</item>
 * OR
    <style name="AppTheme" ...
        <item name="preferenceTheme">@style/AppTheme.PreferenceTheme</item>
    </style>
    <style name="AppTheme.PreferenceTheme"
 parent="PreferenceThemeOverlay.v14.Material"> <item
 name="preferenceCategoryStyle">@style/AppTheme.PreferenceTheme.CategoryStyle</item>
    </style>
    <style name="AppTheme.PreferenceTheme.CategoryStyle"
 parent="Preference.Category"> <item
 name="android:layout">@layout/opoc_pref_category_text</item>
    </style>
...
public abstract class GsPreferenceFragmentCompat<
    AS extends SharedPreferencesPropertyBackend>
  ...
  public Boolean onPreferenceClicked(Preference preference, String key,
                                     int keyResId) {
    return null;
  }

  public String getSharedPreferencesName() { return "app"; }
  ...
  protected void
  onPreferenceScreenChanged(PreferenceFragmentCompat preferenceFragmentCompat,
                            PreferenceScreen preferenceScreen) {}

  public Integer getIconTintColor() { return _defaultIconTintColor; }
  ...
  public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
    ...
    if (activity != null && activity.getTheme() != null) {
      ...
      _defaultIconTintColor =
          _cu.shouldColorOnTopBeLight(bgcolor) ? Color.WHITE : Color.BLACK;
    }
  ...
  public final Callback.a1<PreferenceFragmentCompat> updatePreferenceIcons =
      (frag) -> {
    try {
  ...
  public void tintAllPrefIcons(PreferenceFragmentCompat preferenceFragment,
                               @ColorInt int iconColor) {
    tintPrefIconsRecursive(getPreferenceScreen(), iconColor);
  }

  private void tintPrefIconsRecursive(PreferenceGroup prefGroup,
                                      @ColorInt int iconColor) {
  ...
  protected boolean isAllowedToTint(Preference pref) { return true; }
  ...
  updatePreferenceChangedListeners(boolean shouldListen) {
    String tprefname = getSharedPreferencesName();
    if (shouldListen && tprefname != null &&
        !_registeredPrefs.contains(tprefname)) {
      SharedPreferences preferences =
          _appSettings.getContext().getSharedPreferences(tprefname,
      ...
      for (String prefname : _registeredPrefs) {
        SharedPreferences preferences =
            _appSettings.getContext().getSharedPreferences(
                tprefname, Context.MODE_PRIVATE);
  ...
  protected void onPreferenceChanged(SharedPreferences prefs, String key) {
    // Wait some ms to be sure the pref objects have changed it's internal
    // values and the new values are ready to be read ;)
  ...
  @Override
  public boolean
  onPreferenceStartScreen(PreferenceFragmentCompat preferenceFragmentCompat,
                          PreferenceScreen preferenceScreen) {
   ...
   * @see
   *     android.support.v7.preference.PreferenceGroup#findPreference(CharSequence)
   */
  ...
  updatePreference(@StringRes int keyResId, @DrawableRes Integer iconRes,
                   CharSequence title, CharSequence summary, Boolean visible) {
  ...
  protected void removePreference(@Nullable Preference preference) {
    ...
    PreferenceGroup parent =
        getPreferenceParent(getPreferenceScreen(), preference);
    if (parent == null) {
      return;
    }
  ...
  public boolean canGoBack() { return !_prefScreenBackstack.isEmpty(); }

  public void goBack() {
    if (canGoBack()) {
      PreferenceScreen screen =
          _prefScreenBackstack.remove(_prefScreenBackstack.size() - 1);
      if (screen != null) {
  ...
  protected PreferenceGroup getPreferenceParent(PreferenceGroup prefGroup,
                                                Preference pref) {
  ...
  private void onPreferenceScreenChangedPriv(
  ...
  public boolean hasTitle() { return !TextUtils.isEmpty(getTitle()); }
  ...
  /**
   * Append a pref to given {@code target}. If target is null, the current
   * screen is taken The pref icon is tint according to color
   *
  ...
  public boolean isDividerVisible() { return _isDividerVisible; }
  ...
  public void setDividerVisibility(boolean visible) {
    ...
    if (visible) {
      recyclerView.addItemDecoration(
          new DividerDecoration(getContext(), getDividerColor(),
                                _flatPosIsPreferenceCategoryCallback));
  ...
  public Integer getDividerColor() {
    ...
    try {
      return Color.parseColor(
          au.shouldColorOnTopBeLight(au.getActivityBackgroundColor())
              ? "#3d3d3d"
              : "#d1d1d1");
    } catch (Exception ignored) {
      return null;
        ...
        if (pref != null) {
          if (pref instanceof PreferenceCategory) {
            ...
            for (int j = 0; j < prefSubGroup.getPreferenceCount(); j++) {
              flatPos++;
              if (flatPos == position) {
                return !(prefSubGroup.getPreference(j) instanceof
                         PreferenceCategory);
              }
            }
  ...
  public static class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerDecoration(
        Context context, @Nullable Callback.b1<Integer> isCategoryAtFlatpos) {
    ...
    public DividerDecoration(
        Context context, @Nullable @ColorInt Integer color,
        @Nullable Callback.b1<Integer> isCategoryAtFlatpos) {
      this(context, color, 1f, isCategoryAtFlatpos);
    }

    public DividerDecoration(
        Context context, @Nullable @ColorInt Integer color, float heightDp,
        @Nullable Callback.b1<Integer> isCategoryAtFlatpos) {
      if (color == null) {
      ...
      _heightDp = (int)TypedValue.applyDimension(
    ...
    public void getItemOffsets(@NonNull Rect outRect, @NonNull View view,
      ...
      int viewType = 0;
      try {
        viewType = parent.getAdapter() != null
    ...
    public void onDraw(@NonNull Canvas c, @NonNull RecyclerView parent,
      ...
      for (int i = 0; i < parent.getChildCount(); i++) {
        ...
        int position = parent.getChildAdapterPosition(view);
        if (_isCategoryAtFlatpositionCallback == null ||
            _isCategoryAtFlatpositionCallback.callback(position)) {
          c.drawRect(view.getLeft(), view.getBottom(), view.getRight(),
                     view.getBottom() + _heightDp, _paint);
        }
      }
    }
  }
