 ...
 * Example:
    ...
    public boolean isAppCurrentVersionFirstStart(boolean doSet) {
        int value = getInt(R.string.pref_key__app_first_start_current_version,
...
/**
 * Wrapper for settings based on SharedPreferences, optionally with keys in
 * resources Default SharedPreference (_prefApp) will be taken if no SP is
 * specified, else the first one
 */
@SuppressWarnings(
    {"WeakerAccess", "unused", "SpellCheckingInspection", "SameParameterValue"})
public class SharedPreferencesPropertyBackend
    implements PropertyBackend<String, SharedPreferencesPropertyBackend> {
  ...
  public SharedPreferencesPropertyBackend(final Context context,
                                          final String prefAppName) {
    _context = context.getApplicationContext();
    _prefAppName = TextUtils.isEmpty(prefAppName)
                       ? _context.getPackageName() + "_preferences"
                       : prefAppName;
    _prefApp =
        _context.getSharedPreferences(_prefAppName, Context.MODE_PRIVATE);
  }
  ...
  public void resetSettings() { resetSettings(_prefApp); }
  ...
  public boolean isPrefSet(final SharedPreferences pref,
                           @StringRes int stringKeyResourceId) {
    return pref.contains(rstr(stringKeyResourceId));
  }

  public void registerPreferenceChangedListener(
      SharedPreferences.OnSharedPreferenceChangeListener value) {
  ...
  public void setString(@StringRes int keyResourceId,
                        @StringRes int defaultValueResourceId,
                        final SharedPreferences... pref) {
    gp(pref)
        .edit()
        .putString(rstr(keyResourceId), rstr(defaultValueResourceId))
        .apply();
  }
  ...
  public String getString(@StringRes int keyResourceId,
                          @StringRes int defaultValueResourceId,
                          final SharedPreferences... pref) {
    return gp(pref).getString(rstr(keyResourceId),
                              rstr(defaultValueResourceId));
  }
  ...
  public String getString(@StringRes int keyResourceId, String defaultValue,
                          @StringRes int keyResourceIdDefaultValue,
                          final SharedPreferences... pref) {
    return gp(pref).getString(rstr(keyResourceId),
                              rstr(keyResourceIdDefaultValue));
  }

  private void setStringListOne(String key, List<String> values,
                                final SharedPreferences pref) {
  ...
  private ArrayList<String> getStringListOne(String key,
                                             final SharedPreferences pref) {
  ...
  public void setStringArray(@StringRes int keyResourceId, String[] values,
                             final SharedPreferences... pref) {
  ...
  public void setStringList(@StringRes int keyResourceId, List<String> values,
                            final SharedPreferences... pref) {
    setStringArray(rstr(keyResourceId),
                   values.toArray(new String[values.size()]), pref);
  }
  ...
  public int getIntOfStringPref(String key, int defaultValue,
                                final SharedPreferences... pref) {
    String strNum = getString(key, Integer.toString(defaultValue), gp(pref));
    return Integer.valueOf(strNum);
  }

  private void setIntListOne(String key, List<Integer> values,
                             final SharedPreferences pref) {
    StringBuilder sb = new StringBuilder();
  ...
  private ArrayList<Integer> getIntListOne(String key,
                                           final SharedPreferences pref) {
  ...
  public void setIntArray(@StringRes int keyResourceId, Integer[] values,
                          final SharedPreferences... pref) {
  ...
  public Integer[] getIntArray(@StringRes int keyResourceId,
                               final SharedPreferences... pref) {
  ...
  public void setIntList(@StringRes int keyResourceId, List<Integer> values,
                         final SharedPreferences... pref) {
    setIntListOne(rstr(keyResourceId), values, gp(pref));
  }

  public void setIntList(String key, List<Integer> values,
                         final SharedPreferences... pref) {
    setIntListOne(key, values, gp(pref));
  }

  public ArrayList<Integer> getIntList(@StringRes int keyResourceId,
                                       final SharedPreferences... pref) {
  ...
  //
  public void setFloat(@StringRes int keyResourceId, float value,
                       final SharedPreferences... pref) {
  ...
  public float getFloat(@StringRes int keyResourceId, float defaultValue,
                        final SharedPreferences... pref) {
  ...
  //
  public void setDouble(@StringRes int keyResourceId, double value,
                        final SharedPreferences... pref) {
  ...
  public double getDouble(@StringRes int keyResourceId, double defaultValue,
                          final SharedPreferences... pref) {
  ...
  public double getDouble(String key, double defaultValue,
    ...
    return Double.longBitsToDouble(
        getLong(key, Double.doubleToRawLongBits(defaultValue), gp(pref)));
  }
  ...
  //
  public int getColor(String key, @ColorRes int defaultColor,
                      final SharedPreferences... pref) {
    return gp(pref).getInt(key, rcolor(defaultColor));
  }

  public int getColor(@StringRes int keyResourceId, @ColorRes int defaultColor,
                      final SharedPreferences... pref) {
  ...
  @Override
  public SharedPreferencesPropertyBackend setIntList(String key,
                                                     List<Integer> value) {
  ...
  @Override
  public SharedPreferencesPropertyBackend setStringList(String key,
                                                        List<String> value) {
  ...
  public boolean afterDaysTrue(String key, int daysSinceLastTime, int firstTime,
                               final SharedPreferences... pref) {
  ...
  public static void clearDebugLog() { _debugLog = ""; }

  public static String getDebugLog() { return _debugLog; }
