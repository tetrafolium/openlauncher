...
@SuppressWarnings(
    {"WeakerAccess", "unused", "SameParameterValue", "SpellCheckingInspection"})
public class ActivityUtils extends net.gsantner.opoc.util.ContextUtils {
   ...
   * @param requestCode        Request code for stating the activity, not
   *     waiting for result if null
   */
  public void animateToActivity(Class to, Boolean finishFromActivity,
                                Integer requestCode) {
    animateToActivity(new Intent(_activity, to), finishFromActivity,
                      requestCode);
  }
   ...
   *     waiting for result if null
   */
  public void animateToActivity(Intent intent, Boolean finishFromActivity,
                                Integer requestCode) {
    ...
    _activity.overridePendingTransition(getResId(ResType.DIMEN, "fadein"),
                                        getResId(ResType.DIMEN, "fadeout"));
  ...
  public void showSnackBar(@StringRes int stringResId, boolean showLong,
    ...
    Snackbar
        .make(_activity.findViewById(android.R.id.content), stringResId,
              showLong ? Snackbar.LENGTH_LONG : Snackbar.LENGTH_SHORT)
        .setAction(actionResId, listener)
        .show();
  }

  public ActivityUtils setSoftKeyboardVisibile(boolean visible,
                                               View... editView) {
    final Activity activity = _activity;
    if (activity != null) {
      final View v =
          (editView != null && editView.length > 0)
              ? (editView[0])
    ...
    if (_activity != null) {
      ...
      if (imm != null && _activity.getCurrentFocus() != null &&
        ...
        imm.hideSoftInputFromWindow(
            _activity.getCurrentFocus().getWindowToken(), 0);
      }
    }
    return this;
  }
  ...
  public void showDialogWithHtmlTextView(@StringRes int resTitleId,
                                         String html) {
    showDialogWithHtmlTextView(resTitleId, html, true, null);
  }

  public void showDialogWithHtmlTextView(
      @StringRes int resTitleId, String text, boolean isHtml,
  ...
  public void showDialogWithRawFileInWebView(String fileInRaw,
                                             @StringRes int resTitleId) {
  ...
  toggleStatusbarVisibility(boolean... optionalForceVisible) {
  ...
  public ActivityUtils showGooglePlayEntryForThisApp() {
    ...
    Intent goToMarket =
        new Intent(Intent.ACTION_VIEW, Uri.parse("market://" + pkgId));
  ...
  public ActivityUtils setLauncherActivityEnabled(Class activityClass,
                                                  boolean enable) {
  ...
  public Integer getCurrentPrimaryColor() {
    ...
    _context.getTheme().resolveAttribute(getResId(ResType.ATTR, "colorPrimary"),
                                         typedValue, true);
  ...
  public Integer getCurrentPrimaryDarkColor() {
    TypedValue typedValue = new TypedValue();
    _context.getTheme().resolveAttribute(
        getResId(ResType.ATTR, "colorPrimaryDark"), typedValue, true);
    return typedValue.data;
  }
  ...
  public Integer getCurrentAccentColor() {
    TypedValue typedValue = new TypedValue();
    _context.getTheme().resolveAttribute(getResId(ResType.ATTR, "colorAccent"),
                                         typedValue, true);
    return typedValue.data;
  }
   ...
   */
  public void dialogFullWidth(AlertDialog dialog, boolean fullWidth,
