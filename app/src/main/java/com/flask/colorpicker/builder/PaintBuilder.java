...
public class PaintBuilder {
  ...
  public static class PaintHolder {
    ...
    private PaintHolder() { this.paint = new Paint(Paint.ANTI_ALIAS_FLAG); }
    ...
    public Paint build() { return this.paint; }
  }

  public static Shader createAlphaPatternShader(int size) {
    size /= 2;
    size = Math.max(8, size * 2);
    return new BitmapShader(createAlphaBackgroundPattern(size),
