...
public abstract class AbsCustomSlider extends View {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    try {
      inVerticalOrientation = styledAttrs.getBoolean(
          R.styleable.AbsCustomSlider_inVerticalOrientation,
          inVerticalOrientation);
    } finally {
      styledAttrs.recycle();
    }
  }
  ...
  protected void createBitmaps() {
    ...
    bar = Bitmap.createBitmap(width - barOffsetX * 2, barHeight,
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (bar != null && bitmapCanvas != null) {
      ...
      bitmapCanvas.drawBitmap(bar, barOffsetX, (height - bar.getHeight()) / 2,
                              null);
  ...
  public void
  setOnValueChangedListener(OnValueChangedListener onValueChangedListener) {
