...
public class MinibarEditActivity
	extends ColorActivity implements ItemTouchCallback {
@BindView(R.id.toolbar) Toolbar _toolbar;
@BindView(R.id.enableSwitch) SwitchCompat _enableSwitch;
...
public void onCreate(Bundle savedInstanceState) {
	...
	final ArrayList<LauncherAction.ActionDisplayItem> minibarArrangement =
	...
	_enableSwitch.setOnCheckedChangeListener(
		new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
			        ...
			        if (HomeActivity.Companion.getLauncher() != null) {
			                ...
			                .getDrawerLayout()
			                .setDrawerLockMode(
						isChecked ? DrawerLayout.LOCK_MODE_UNLOCKED
...
public void bindView(ViewHolder holder, List payloads) {
	...
	holder._cb.setOnCheckedChangeListener(
		new CompoundButton.OnCheckedChangeListener() {
				@Override
