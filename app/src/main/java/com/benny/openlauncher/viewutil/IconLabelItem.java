...
public class IconLabelItem
    extends AbstractItem<IconLabelItem, IconLabelItem.ViewHolder> {
  ...
  public IconLabelItem
  withOnLongClickListener(View.OnLongClickListener onLongClickListener) {
  ...
  public void bindView(@NonNull ViewHolder holder,
    ...
    if (_iconSize != Integer.MAX_VALUE) {
      _icon = new BitmapDrawable(
          Setup.appContext().getResources(),
          Bitmap.createScaledBitmap(Tool.drawableToBitmap(_icon), _iconSize,
                                    _iconSize, true));
    ...
    case Gravity.START:
      if (_isAppLauncher) {
        ...
        holder.textView.setCompoundDrawablesWithIntrinsicBounds(_icon, null,
                                                                null, null);
      }
      break;
    case Gravity.END:
    ...
    case Gravity.TOP:
      if (_isAppLauncher) {
        ...
        holder.textView.setCompoundDrawablesWithIntrinsicBounds(null, _icon,
                                                                null, null);
      }
      break;
    case Gravity.BOTTOM:
  ...
  public void setIconGravity(int iconGravity) { _iconGravity = iconGravity; }

  public void setTextGravity(int textGravity) { _textGravity = textGravity; }
}
