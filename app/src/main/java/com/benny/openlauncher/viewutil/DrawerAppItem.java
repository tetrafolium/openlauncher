...
public class DrawerAppItem
    extends AbstractItem<DrawerAppItem, DrawerAppItem.ViewHolder> {
  private App _app;
  ...
  public void bindView(DrawerAppItem.ViewHolder holder, List payloads) {
    ...
    holder.builder.setAppItem(item).withOnLongClick(
        item, DragAction.Action.DRAWER, null);
  ...
  static class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder(View itemView) {
      ...
      builder =
          new AppItemView.Builder(appItemView)
