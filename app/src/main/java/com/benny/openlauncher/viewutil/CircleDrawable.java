...
public CircleDrawable(Context context, Drawable icon, int colorIcon,
                      int colorBackground, int alphaBackground) {
...
public void draw(Canvas canvas) {
	...
	if (_iconToFade != null) {
		...
		canvas.drawBitmap(_hidingOldIcon ? _iconToFade : _icon,
		                  _iconSize / 2 - _iconSizeReal / 2,
		                  _iconSize / 2 - _iconSizeReal / 2, _paint2);
		canvas.restore();
		...
		canvas.drawBitmap(_icon, _iconSize / 2 - _iconSizeReal / 2,
		                  _iconSize / 2 - _iconSizeReal / 2, _paint2);
	}
}
