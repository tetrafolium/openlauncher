...
public class DesktopGestureListener
    implements SimpleFingerGestures.OnFingerGestureListener {
  ...
  public DesktopGestureListener(Desktop desktop,
                                DesktopGestureCallback callback) {
    _desktop = desktop;
    _callback = callback;
  }
