...
public boolean onPreferenceTreeClick(Preference preference) {
	...
	case R.string.pref_key__backup:
		if (new PermissionChecker(getActivity())
		    .doIfExtStoragePermissionGranted()) {
			Intent i =
				new Intent(getActivity(), FilePickerActivity.class)
	...
	case R.string.pref_key__reset_settings:
		DialogHelper.alertDialog(
			getActivity(), getString(R.string.pref_title__reset_settings),
			...
			new MaterialDialog.SingleButtonCallback() {
				...
				public void onClick(@NonNull MaterialDialog dialog,
				        ...
				        Toast
				        .makeText(HomeActivity._launcher,
				                  R.string.toast_settings_restored,
				                  Toast.LENGTH_SHORT)
				        .show();
				}
			});
	...
	case R.string.pref_key__reset_database:
		DialogHelper.alertDialog(
			getActivity(), getString(R.string.pref_title__reset_database),
			getString(R.string.are_you_sure),
			new MaterialDialog.SingleButtonCallback() {
				@Override
				public void onClick(@NonNull MaterialDialog dialog,
				        ...
				        Toast
				        .makeText(HomeActivity._launcher,
				                  R.string.toast_database_deleted, Toast.LENGTH_SHORT)
				        .show();
				}
			});
		return true;
