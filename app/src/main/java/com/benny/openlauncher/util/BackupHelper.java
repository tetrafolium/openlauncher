...
public class BackupHelper {
  public static void backupConfig(Context context, String file) {
    ...
    try {
      ...
      Toast.makeText(context, R.string.toast_backup_success, Toast.LENGTH_SHORT)
          .show();
      zos.flush();
      zos.close();
    } catch (Exception e) {
      Toast.makeText(context, R.string.toast_backup_error, Toast.LENGTH_SHORT)
          .show();
    }
  }
  ...
  public static void addFileToZip(ZipOutputStream outZip, String file,
                                  String name) throws Exception {
    byte data[] = new byte[Definitions.BUFFER_SIZE];
    FileInputStream fi = new FileInputStream(file);
    BufferedInputStream inputStream =
        new BufferedInputStream(fi, Definitions.BUFFER_SIZE);
  ...
  public static boolean extractFileFromZip(String filePath, String file,
                                           String name) throws Exception {
