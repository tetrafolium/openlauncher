...
public class AppSettings extends SharedPreferencesPropertyBackend {
  public AppSettings(Context context) { super(context, "app"); }

  public static AppSettings get() { return new AppSettings(AppObject.get()); }
  ...
  public int getDesktopIndicatorMode() {
    return getIntOfStringPref(R.string.pref_key__desktop_indicator_style,
                              PagerIndicator.Mode.DOTS);
  }
  ...
  public Definitions.WallpaperScroll getDesktopWallpaperScroll() {
    int value =
        getIntOfStringPref(R.string.pref_key__desktop_wallpaper_scroll, 0);
    switch (value) {
    case 0:
    default:
  ...
  public String getSearchBarBaseURI() {
    return getString(R.string.pref_key__search_bar_base_uri,
                     R.string.pref_default__search_bar_base_uri);
  }
  ...
  public DateTimeFormatter getUserDateFormat() {
    String line1 =
        getString(R.string.pref_key__date_bar_date_format_custom_1,
                  rstr(R.string.pref_default__date_bar_date_format_custom_1));
    String line2 =
        getString(R.string.pref_key__date_bar_date_format_custom_2,
                  rstr(R.string.pref_default__date_bar_date_format_custom_2));
  ...
  public int getDesktopBackgroundColor() {
    return getInt(R.string.pref_key__desktop_background_color,
                  Color.TRANSPARENT);
  }
  ...
  public int getMinibarBackgroundColor() {
    return getInt(R.string.pref_key__minibar_background_color,
                  ContextCompat.getColor(_context, R.color.colorPrimary));
  }

  public int getDesktopIconSize() { return getIconSize(); }
  ...
  public int getDockIconSize() { return getIconSize(); }
  ...
  public int getDrawerStyle() {
    return getIntOfStringPref(R.string.pref_key__drawer_style,
  ...
  public int getDrawerBackgroundColor() {
    return getInt(R.string.pref_key__drawer_background_color,
                  rcolor(R.color.shade));
  }
  ...
  public int getDrawerFastScrollColor() {
    return getInt(
        ...
        ContextCompat.getColor(Setup.appContext(), R.color.materialRed));
  }
  ...
  public Object getGesture(int key) {
    ...
    if (gesture == null) {
      ...
      if (AppManager.getInstance(_context).findApp((Intent)gesture) == null)
        gesture = null;
    }
  ...
  public String getTheme() { return getString(R.string.pref_key__theme, "1"); }

  public int getPrimaryColor() {
    return getInt(R.string.pref_key__primary_color,
                  _context.getResources().getColor(R.color.colorPrimary));
  }

  public int getIconSize() { return getInt(R.string.pref_key__icon_size, 52); }
  ...
  public ArrayList<LauncherAction.ActionDisplayItem> getMinibarArrangement() {
    ArrayList<String> minibarString =
        getStringList(R.string.pref_key__minibar_items);
    ArrayList<LauncherAction.ActionDisplayItem> minibarObject =
        new ArrayList<>();
    for (String action : minibarString) {
      LauncherAction.ActionDisplayItem item =
          LauncherAction.getActionItem(action);
      if (item != null) {
        minibarObject.add(item);
      }
    }
    if (minibarObject.isEmpty()) {
      for (LauncherAction.ActionDisplayItem item :
           LauncherAction.actionDisplayItems) {
  ...
  public void setAppRestartRequired(boolean value) {
    // MUST be committed
    _prefApp.edit()
        .putBoolean(_context.getString(R.string.pref_key__queue_restart), value)
        .commit();
  }
  ...
  public void setAppShowIntro(boolean value) {
    // MUST be committed
    _prefApp.edit()
        .putBoolean(_context.getString(R.string.pref_key__show_intro), value)
        .commit();
  }
  ...
  public void setAppFirstLaunch(boolean value) {
    // MUST be committed
    _prefApp.edit()
        .putBoolean(_context.getString(R.string.pref_key__first_start), value)
        .commit();
  }
}
