...
public class Item {
  ...
  public static Item newShortcutItem(Intent intent, Drawable icon,
                                     String name) {
    Item item = new Item();
  ...
  public static Item newWidgetItem(ComponentName componentName,
                                   int widgetValue) {
    Item item = new Item();
    item._type = Type.WIDGET;
    item._label = componentName.getPackageName() + Definitions.DELIMITER +
  ...
  public Intent getIntent() { return _intent; }
  ...
  public void setSpanX(int x) { _spanX = x; }

  public int getSpanY() { return _spanY; }

  public void setSpanY(int y) { _spanY = y; }

  public Drawable getIcon() { return _icon; }

  public enum Type { APP, SHORTCUT, GROUP, ACTION, WIDGET }

  public void setType(Type type) { _type = type; }

  public void setIcon(Drawable icon) { _icon = icon; }

  public void setIntent(Intent intent) { _intent = intent; }

  public List<Item> getItems() { return _items; }

  public void setItems(List<Item> items) { _items = items; }

  public int getActionValue() { return _actionValue; }

  public void setActionValue(int actionValue) { _actionValue = actionValue; }

  public int getWidgetValue() { return _widgetValue; }

  public void setWidgetValue(int widgetValue) { _widgetValue = widgetValue; }
}
